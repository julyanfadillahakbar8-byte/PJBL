...
function seed_default_reviews(PDO $pdo): void
{
    $defaults = [
        ...
        [3, 'Sarah Chen', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80', '', 'Batik Tulis Yogyakarta', 'Perajin', 5, 'Perajin sangat sabar menjelaskan filosofi di balik setiap motif batik. Pengalaman yang sangat berkesan.', 'Disetujui'],
        [4, 'Michael Rodriguez', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&q=80', '', 'Ukiran Kayu Jepara', 'Perajin', 5, 'Proses pengerjaan detail dan profesional. Hasil karyanya melebihi ekspektasi.', 'Disetujui'],
        [5, 'Priya Sharma', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80', '', 'Kerajinan Logam Tradisional', 'Perajin', 5, 'Komunikasi dengan perajin sangat lancar dan hasil akhirnya memuaskan.', 'Disetujui'],
        ...
        [7, 'Gatot Subroto', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&q=80&w=80&h=80', '', 'Program Perajin Lokal', 'Kontak', 5, 'Platform ini membantu perajin lokal memperkenalkan produk tradisional ke kancah nasional.', 'Disetujui'],
